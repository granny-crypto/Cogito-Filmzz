...
export default function App() {
  ...
  const isCleanShowcaseMovie = useCallback((m: Movie) => {
    ...
    if (m.posterUrl.includes("1489599849927")) return false;
    if (m.posterUrl.includes("unsplash.com")) return false;
    if (failedPosterMovieIds.has(m.id)) return false;
    return true;
  }, [failedPosterMovieIds]);
